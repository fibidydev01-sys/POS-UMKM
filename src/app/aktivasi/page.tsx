        ...
        {step === 1 ? (
          ...
          <div className="flex flex-col gap-4 rounded-2xl border border-border bg-card p-5 shadow-sm">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Input id="alamat" value={alamat} onChange={(e) => setAlamat(e.target.value)} placeholder="Opsional" />
            </div>
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="telp">No. telepon</Label>
              <Input id="telp" value={telp} onChange={(e) => setTelp(e.target.value)} placeholder="Opsional" inputMode="tel" />
            </div>
            <div className="flex flex-col gap-1.5">
